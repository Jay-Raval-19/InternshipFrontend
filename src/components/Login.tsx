...
const LoginModal: React.FC<LoginModalProps> = ({ isOpen, onClose, onAuthSuccess }) => {
  ...
  // Save phone after Google sign-in (to Firestore)
  const handlePhoneSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    console.log('Starting phone submission...', { googleUser, phone });
    
    try {
      if (!googleUser || !googleUser.uid) {
        throw new Error('No Google user found. Please try signing in again.');
      }
      ...
      await setDoc(doc(db, 'users', googleUser.uid), userData, { merge: true });
      onAuthSuccess(userData);
      
      // Show success message
      alert('Sign up completed successfully! Welcome to Sourceasy.');
            ...
            <div className="login-form">
              <div className="form-group">
                ...
                <p className="form-description">
                  We'll ask for your phone number after you sign in to complete your profile.
                </p>
              </div>
